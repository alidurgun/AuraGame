...
UAuraAttributeSet::UAuraAttributeSet()
{
	...
	TagsToAttribute.Add(Tags.Attributes_Resistance_Arcane, GetArcaneResistanceAttribute);
	TagsToAttribute.Add(Tags.Attributes_Resistance_Fire, GetFireResistanceAttribute);
	TagsToAttribute.Add(Tags.Attributes_Resistance_Lightning, GetLightningResistanceAttribute);
	TagsToAttribute.Add(Tags.Attributes_Resistance_Physical, GetPhysicalResistanceAttribute);
...
void UAuraAttributeSet::PostGameplayEffectExecute(const struct FGameplayEffectModCallbackData& Data)
{
	...
	if (Data.EvaluatedData.Attribute == GetIncomingDamageAttribute())
	{
		...
		if (LocalIncomingDamage > 0.0f)
		{
			...
			{
				// Activate ability by tag. GA_HitReact will have this tag.
